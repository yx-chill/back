<template>
  <Listbox v-model="selected">
    <div class="relative">
      ...
      <TransitionZoom>
        <ListboxOptions class="absolute z-[1] w-full py-1 mt-1 overflow-auto text-base
          bg-white rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5
          focus:outline-none origin-top-right sm:text-sm">
          <ListboxOption
            ...
            :value="option.value"
            as="template">
            <li class="cursor-pointer select-none relative py-2 pl-10 pr-4 text-gray-800"
